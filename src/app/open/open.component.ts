...
export class OpenComponent implements OnInit {
  ...
  async closeMaterialRequest(data){
    ...
    await this.materialRequestService.closeMaterialRequest(materialRequestId,employeeId).then(data=>{
      this.notifier.showSuccess("Closed Success!");
